...
import com.massa.category.domain.Category;
import com.massa.category.repository.CategoryRepository;
...
/**
 * REST controller for managing {@link com.massa.category.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CategoryResource {
    ...
    public ResponseEntity<List<Category>> getAllCategories(Pageable pageable, @RequestParam(required = false) String filter) {
        if ("category-is-null".equals(filter)) {
            log.debug("REST request to get all Categorys where category is null");
